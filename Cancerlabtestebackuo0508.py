...
PUBLIC_PAGES = {"home", "research", "publications", "people", "partners", "positions", "equipment", "news"}
...
elif active_nav == "login":
    if st.session_state.get("page") not in {"criar_conta", "reset_request", "reset"}:
        st.session_state.page = "login"
