...
# PÁGINA INICIAL
    ...
    # -------- Edição dos dados do paciente (com 1 botão que já salva no Excel) --------
    st.markdown("---")
    ...
    with st.form(f"form_edicao_{idx}"):
        ...
        # sua versão do Streamlit não aceita 'key' aqui
        salvar_paciente = st.form_submit_button(
            "Salvar paciente (memória + Excel)"
        )
    ...
    # =================== Salvar na planilha (persistência manual – perto da edição) ===================
    st.markdown("---")
