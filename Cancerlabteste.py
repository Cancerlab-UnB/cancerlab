...
page_url = _get_param("page", "home")

if "page" not in st.session_state:
    st.session_state.page = page_url if page_url in valid_pages else "home"
...
if st.session_state.page == "login":
    ...
    with st.form("form_criar_conta", clear_on_submit=False):
        ...
        perfil = st.radio("Tipo de usuário", ["aluno", "servidor"], key="cad_perfil")
    ...
    if st.button("Voltar para login", key="btn_voltar_login_cadastro"):
        st.session_state.page = "login"
        _set_param(page="login")
        st.rerun()
